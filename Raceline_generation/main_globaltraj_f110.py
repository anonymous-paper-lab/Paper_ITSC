...
parser.add_argument('--map_name', type=str, default='race_track', help='Name of the map (default: race_track)')
...
file_paths["traj_race_export"] = os.path.join(file_paths["module"], f"outputs/{MAP_NAME}", f"traj_race_ax3_ay6_vmax30_FTM.csv")
...
# mu definition as an array with the same shape as kappa_opt
mu_array = np.full(kappa_opt.shape, pars["optim_opts"]["mue"])
...
# # debug
# print(" el_lengths:", len(el_lengths_opt_interp))
# print(" kappa:", len(kappa_opt))
# print(" vx_profile_opt:", len(vx_profile_opt))
# print("vx_profile_opt:", vx_profile_opt)
...
# debug
# print(" vx_profile_opt:", len(vx_profile_opt_cl))
...
if plot_opts["racetraj_vel"]:
    ...
    plt.plot(s_points, vx_profile_opt[:-1])
...
# DATA POSTPROCESSING --------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------
ax_profile_opt = np.insert(ax_profile_opt, 0, 0.0)
# print("s_points_opt_interp:", len(s_points_opt_interp))
# print("raceline_interp:", len(raceline_interp))
# print("psi_vel_opt:", len(psi_vel_opt))
# print("kappa_opt:", len(kappa_opt))
# print("vx_profile_opt:", len(vx_profile_opt))
# print("ax_profile_opt:", len(ax_profile_opt))
...
#### Plot of the ggv diagram
# Calcolo dell'accelerazione laterale
ay_profile_opt = vx_profile_opt**2 * kappa_opt

# Plot GGV
plt.figure(figsize=(8, 8))
sc = plt.scatter(ay_profile_opt, ax_profile_opt, c=vx_profile_opt, cmap='viridis', s=60, edgecolor='k')
